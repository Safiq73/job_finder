...
anonymous = True
total_pages = 20
url_link = 'https://in.indeed.com/jobs?q='+query.replace(" ", "+")+'&l='+location + '&fromage=' +str(past_date)
...
for i in range(0,total_pages):
    ...
    driver.get(str(url_link)+'&start='+str(25*i))
        
    search_results = driver.find_elements(By.CSS_SELECTOR, '.jobTitle a')
